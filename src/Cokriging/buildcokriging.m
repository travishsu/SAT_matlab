...
ModelInfo.muc=(ones(nc,1)'*(ModelInfo.PsicXc\yc))/(ones(nc,1)'*(ModelInfo.PsicXc\ones(nc,1)));
...
ModelInfo.mud=(ones(ne,1)'*(ModelInfo.PsidXe\ModelInfo.d))/(ones(ne,1)'*(ModelInfo.PsidXe\ones(ne,1)));

% ModelInfo.SigmaSqrc=(yc-ones(nc,1).*ModelInfo.muc)'*(ModelInfo.UPsicXc\(ModelInfo.UPsicXc'\(yc-ones(nc,1).*ModelInfo.muc)))/nc;
ModelInfo.SigmaSqrc=(yc-ones(nc,1).*ModelInfo.muc)'*(ModelInfo.PsicXc\(yc-ones(nc,1).*ModelInfo.muc))/nc;
...
ModelInfo.SigmaSqrd=(ModelInfo.d-ones(ne,1).*ModelInfo.mud)'*(ModelInfo.PsidXe\(ModelInfo.d-ones(ne,1).*ModelInfo.mud))/ne;
...
ModelInfo.invC = inv(ModelInfo.C);
